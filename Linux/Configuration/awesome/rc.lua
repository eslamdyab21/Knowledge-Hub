...
awful.util.gnome_terminal = gnome_terminal
awful.util.tagnames = { " O ", " O ", " web ", " O ", " etc ", " O " }
...
globalkeys = awful.util.table.join(
    ...
    -- awful.key({ ctrlkey,           }, "Left",   awful.tag.viewprev,
    --           {description = "view previous", group = "tag"}),
    -- awful.key({ ctrlkey,           }, "Right",  awful.tag.viewnext,
    --           {description = "view next", group = "tag"}),
    ...
    -- Programms
    awful.key({ modkey            }, "c", function()  awful.util.spawn("sublime") end),
    awful.key({ modkey            }, "v", function()  awful.util.spawn("sublime -n") end),
    awful.key({ modkey            }, "x", function() awful.util.spawn_with_shell("terminal") end ),
    awful.key({ modkey            }, "r", function() awful.util.spawn_with_shell("ulauncher") end ),
    awful.key({ modkey            }, "p", function() awful.util.spawn_with_shell("~/./Pensela.sh") end ),
    awful.key({ modkey            }, "z", function() awful.util.spawn_with_shell("gnome-terminal") end ),
    awful.key({ modkey            }, "b", function() awful.util.spawn_with_shell("brave-browser") end ),
    awful.key({ modkey            }, "e", function() awful.util.spawn_with_shell('nautilus') end ),
